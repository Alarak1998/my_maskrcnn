...
def main(parser_data):
    ...
    det_metric = EvalCOCOMetric(val_dataset.coco, "bbox", "./checkpoints/det_results.json")
    seg_metric = EvalCOCOMetric(val_dataset.coco, "segm", "./checkpoints/seg_results.json")
    model.eval()
    with torch.no_grad():
